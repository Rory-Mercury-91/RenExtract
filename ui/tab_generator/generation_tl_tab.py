...
# OBSOLÈTE: Cette fonction est remplacée par le système unifié "Options screen preferences"
# def create_fontsize_selector_only(main_interface):
#     """Crée uniquement le contrôle de taille de police"""
#     try:
...
# 
#         translation_business = main_interface._get_translation_business()
#         success, message = translation_business.create_language_selector_modular(
#             main_interface.current_project_path,
#             language,
#             include_language=False,
#             include_fontsize=True
#         )
# 
#         notification_mode = config_manager.get('notification_mode', 'status_only')
# 
#         if success:
#             main_interface._update_status(f"Contrôle taille police créé avec succès")
#             
#             if notification_mode == 'detailed_popups':
#                 show_translated_messagebox(
#                     'info',
#                     'Contrôle taille police créé',
#                     f"Le contrôle de taille de police a été créé avec succès :\n\n{message}",
#                     parent=main_interface.window
#                 )
#         else:
#             main_interface._update_status(f"Échec création contrôle taille")
#             
#             if notification_mode == 'detailed_popups':
#                 show_translated_messagebox(
#                     'error',
#                     'Échec création contrôle taille',
#                     f"Impossible de créer le contrôle de taille :\n\n{message}",
#                     parent=main_interface.window
#                 )
# 
#         log_message("INFO" if success else "ATTENTION", f"Contrôle taille : {message}", category="renpy_generator_tl")
# 
#     except Exception as e:
#         main_interface._update_status(f"Erreur contrôle taille : {e}")
#         
#         notification_mode = config_manager.get('notification_mode', 'status_only')
#         if notification_mode == 'detailed_popups':
#             show_translated_messagebox(
#                 'error',
#                 'Erreur contrôle taille',
#                 f"Une erreur inattendue s'est produite :\n\n{e}",
#                 parent=main_interface.window
#             )
#             
#         log_message("ERREUR", f"Erreur création contrôle taille seul : {e}", category="renpy_generator_tl")

# OBSOLÈTE: Cette fonction est remplacée par le système unifié "Options screen preferences"
# def create_language_selector_only(main_interface):
#     """Crée uniquement le sélecteur de langue sans génération"""
#     try:
#         if not main_interface.current_project_path:
#             main_interface._update_status('Veuillez sélectionner un projet Ren\'Py')
#             return
...
#             include_fontsize=False
#         )
#         
#         # Vérifier le mode de notification
#         notification_mode = config_manager.get('notification_mode', 'status_only')
#         
#         if success:
#             main_interface._update_status(f"Sélecteur de langue créé avec succès")
#             
#             if notification_mode == 'detailed_popups':
#                 show_translated_messagebox(
#                     'info',
#                     'Sélecteur de langue créé',
#                     f"Le sélecteur de langue a été créé avec succès :\n\n{message}",
#                     parent=main_interface.window
#                 )
#         else:
#             main_interface._update_status(f"Échec création sélecteur")
#             
#             if notification_mode == 'detailed_popups':
#                 show_translated_messagebox(
#                     'error',
#                     'Échec création sélecteur de langue',
#                     f"Impossible de créer le sélecteur de langue :\n\n{message}\n\nVérifiez que le projet contient un fichier screens.rpy valide.",
#                     parent=main_interface.window
#                 )
#             
#         log_message("INFO" if success else "ATTENTION", f"Sélecteur : {message}", category="renpy_generator_tl")
#             
#     except Exception as e:
#         main_interface._update_status(f"Erreur sélecteur : {e}")
#         
#         notification_mode = config_manager.get('notification_mode', 'status_only')
#         if notification_mode == 'detailed_popups':
#             show_translated_messagebox(
#                 'error',
#                 'Erreur sélecteur de langue',
#                 f"Une erreur inattendue s'est produite :\n\n{e}",
#                 parent=main_interface.window
#             )
#             
#         log_message("ERREUR", f"Erreur création sélecteur seul : {e}", category="renpy_generator_tl")
